...
In questo capitolo verrà discussa l'effettiva realizzazione del progetto \textbf{VisitPaestum}, ovvero analisi dei requisiti, progettazione, sviluppo e testing, secondo le metodologie agili.
...
\end{itemize}
Per cui abbiamo un modello dei dati che è rappresentato dalla fig. \ref{datamodelprimaterazione}.
\begin{figure}
...
\end{itemize}
Per cui abbiamo un modello dei dati che è rappresentato dalla fig. \ref{datamodelsecondaiterazione}.
\begin{figure}
...
\end{itemize}
Per cui abbiamo un modello dei dati che è rappresentato dalla fig. \ref{datamodelterzaiterazione}.
\begin{figure}
